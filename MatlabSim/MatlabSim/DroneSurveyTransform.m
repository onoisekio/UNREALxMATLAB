function UnrealToWorldTransform(block, i)
...
%Transform inputs (1)
block.InputPort(1).Dimensions        = [3 3];  % Unreal to World Transform (1,:)
block.InputPort(1).DatatypeID  = 0;  % double
block.InputPort(1).Complexity  = 'Real';
block.InputPort(1).DirectFeedthrough = true;

% Transform inputs(2)
block.InputPort(2).Dimensions        = 3;   % Unreal to World Transform (2,:)
...
intOut = double([block.InputPort(2).Data(1), block.InputPort(2).Data(2), 1] * block.InputPort(1).Data);
Out = intOut/intOut(3);
block.OutputPort(1).Data = Out(1:2);  %[Long Lat]
%Out
